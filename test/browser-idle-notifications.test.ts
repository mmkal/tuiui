...
function createHarness(input: { permission: NotificationPermission | "unsupported"; enabled: boolean }) {
  ...
  const notifications = createNotificationApi(input.permission);
...
function createNotificationApi(permission: NotificationPermission | "unsupported") {
